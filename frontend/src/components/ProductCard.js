      ...
      >
        ...
        >
          ...
          <div className="product-image">
            <img src={watch} className="img-fluid w-100" alt="product img" />
            <img src={watch2} className="img-fluid w-100" alt="product img" />
          </div>
          <div className="product-details">
            <h6 className="brand">Apple</h6>
            <h5 className="product-title">
              Apple Smartwatch for men, women and kids
            </h5>
            <ReactStars
              count={5}
              size={24}
